...
public class Solution implements Serializable {
    ...
    public static class A {//так как класс не поддерживает интерфес сериализабл ... тоя для него не поддерживается встроенный процесс с
        //сериализации ..дессериализациии ннеобходим конструктор по умолчанию
        public A() {
        }
    ...
    public class B extends A implements Serializable {
        ...
        private void readObject(ObjectInputStream ois) throws IOException, ClassNotFoundException {
            ...
            nameA = (String) ois.readObject();//необходимо применить ручной вариант сериализации для поля данных
        }
    }
