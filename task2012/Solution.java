...
public class Solution {
    ...
    public static class OutputToConsole implements Externalizable {
        ...
        public OutputToConsole() {//важно иметь конструктор по умолчанию при восстановлении объекта при Ехтернаблэ !)
       }
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("C:\\Users\\hooty\\Desktop\\Jrush\\JavaRushTasks\\2.JavaCore\\src\\com\\javarush\\task\\task20\\task2012\\file1"));
        oos.writeObject(otc);
        oos.close();
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream("C:\\Users\\hooty\\Desktop\\Jrush\\JavaRushTasks\\2.JavaCore\\src\\com\\javarush\\task\\task20\\task2012\\file1"));
