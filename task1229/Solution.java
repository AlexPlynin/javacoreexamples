...
public class Solution {
    ...
    public static class SEO implements Businessman{
        @Override
        public void workHard() {
    ...
    public static class CTO extends SEO implements Businessman {
//явное указание имплимента, хотя по умолчанию класс реализует интерфейс businesman
    }
}
