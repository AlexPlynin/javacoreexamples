...
public class Solution {
    ...
    interface Desire {//так как переменная INDEX static то сначала к ней прибавится 1 потом еще 1 следовательно вывод = 2 3
    }

    interface Dream {
         Hobbie HOBBIE = new Hobbie();//неявный статический метод!
    }
