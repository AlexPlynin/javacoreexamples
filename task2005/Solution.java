...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = File.createTempFile("C:\\Users\\hooty\\Desktop\\Jrush\\JavaRushTasks\\2.JavaCore\\src\\com\\javarush\\task\\task20\\task2005\\file1", null);
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            if (this.assets.size() > 0) {
                ...
                //printWriter.println(current.getPr);
            }
            printWriter.close();
        }
